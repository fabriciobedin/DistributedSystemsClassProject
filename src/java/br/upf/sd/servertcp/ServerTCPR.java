 ...
 * @author fabricio
 */
public class ServerTCPR implements Runnable{
    
    private static Socket cliente;

    public ServerTCPR(Socket cliente) {
    ...
    public static void main(String[] args) {
       ...
       try {
            ...
            while (conectado) {
                ...
                ServerTCPR tratamento = new ServerTCPR(cliente);
                Thread clienteConectado = new Thread(tratamento);
